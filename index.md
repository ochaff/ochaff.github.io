...
<section class="portfolio-section plain-section" id="teachings" aria-labelledby="teachings-title">
  ...
  <div class="resource-grid talk-grid">
    <article class="resource-card"><img src="{{ '/assets/talk-previews/hierarchy-aware-probabilistic-forecasting-in-financial-markets.jpeg' | relative_url }}" alt="Preview for Hierarchy Aware Forecasting in Financial Markets" loading="lazy"><div><h3>Hierarchy Aware Forecasting in Financial Markets</h3><p>This talk provides an introduction to hierarchical time series with probabilistic forecasting applications. Visualizations and geometric arguments show the value of hierarchical constraints for forecasting.</p><a class="card-link" href="https://quantinar.com/course/1042/hierarchy-aware-probabilistic-forecasting-in-financial-markets" target="_blank" rel="noreferrer">View talk <span aria-hidden="true">↗</span></a></div></article>
    <article class="resource-card"><img src="{{ '/assets/talk-previews/hierarchical-loan-forecasting.jpeg' | relative_url }}" alt="Preview for Hierarchical Loan Forecasting" loading="lazy"><div><h3>Hierarchical Loan Forecasting</h3><p>This talk explores end-to-end reconciled probabilistic forecasting methods for financial hierarchical time series.</p><a class="card-link" href="https://quantinar.com/course/891/hierarchical-loan-forecasting?q=Hierarchical%20Loan%20Forecasting" target="_blank" rel="noreferrer">View talk <span aria-hidden="true">↗</span></a></div></article>
    <article class="resource-card"><img src="{{ '/assets/talk-previews/proper-scoring-rules.jpeg' | relative_url }}" alt="Preview for Proper Scoring Rules" loading="lazy"><div><h3>Proper Scoring Rules</h3><p>This talk introduces proper scoring rules for probabilistic forecast evaluation, including discrimination, multivariate scoring rules, and applications.</p><a class="card-link" href="https://quantinar.com/course/991/proper-scoring-rules" target="_blank" rel="noreferrer">View talk <span aria-hidden="true">↗</span></a></div></article>
    <article class="resource-card"><img src="{{ '/assets/talk-previews/stablising-stablecoin-risks.jpeg' | relative_url }}" alt="Preview for Stabilising Stablecoin Risks" loading="lazy"><div><h3>Stabilising Stablecoin Risks</h3><p>This talk introduces the onchain mechanisms that determine stablecoin prices and a two-pronged model for stablecoin risk monitoring in an AMM pool.</p><a class="card-link" href="https://quantinar.com/course/1064/stabilising-stablecoin-risks" target="_blank" rel="noreferrer">View talk <span aria-hidden="true">↗</span></a></div></article>
    <article class="resource-card"><img src="{{ '/assets/talk-previews/a-technical-introduction-to-polymarket.jpeg' | relative_url }}" alt="Preview for Polymarket: A technical Introduction" loading="lazy"><div><h3>Polymarket: A technical Introduction</h3><p>This talk provides a technical introduction to Polymarket’s onchain aspects and data collection using subgraphs.</p><a class="card-link" href="https://quantinar.com/course/100035/a-technical-introduction-to-polymarket" target="_blank" rel="noreferrer">View talk <span aria-hidden="true">↗</span></a></div></article>
  </div>
</section>
...
<section class="portfolio-section plain-section" id="code" aria-labelledby="code-title">
  ...
  <div class="resource-grid code-grid">
    <article class="resource-card"><img src="{{ '/assets/code-previews/onchain-insight-code.png' | relative_url }}" alt="Onchain insights code output" loading="lazy"><div><h3>Onchain insights</h3><p>Reproducible code for studying onchain liquidity conditions, including functional analysis of the Uniswap liquidity curve and a probabilistic neural-network forecaster for stablecoin tail risk.</p><p class="companion">Companion code to <a href="https://quantinar.com/course/1064/stabilising-stablecoin-risks" target="_blank" rel="noreferrer">Stabilising Stablecoin Risks</a>.</p><a class="card-link" href="https://github.com/QuantLet/onchain-insights" target="_blank" rel="noreferrer">View code <span aria-hidden="true">↗</span></a></div></article>
    <article class="resource-card"><img src="{{ '/assets/code-previews/hierarchy-aware-code.png' | relative_url }}" alt="Onchain data code output" loading="lazy"><div><h3>Onchain data</h3><p>Open source code for collection and preprocessing of the public dataset.</p><a class="card-link" href="https://github.com/MSCA-DN-Digital-Finance/stablecoin-onchain-data" target="_blank" rel="noreferrer">View code <span aria-hidden="true">↗</span></a></div></article>
    <article class="resource-card"><img src="{{ '/assets/code-previews/network-centrality-code.png' | relative_url }}" alt="Network centrality code output" loading="lazy"><div><h3>Network centrality</h3><p>Reproducible code for graph centrality usage examples.</p><p class="companion">Companion code to <a href="https://quantinar.com/coursecontent/100040/graph-centrality-measures" target="_blank" rel="noreferrer">Graph Centrality Measures</a>.</p><a class="card-link" href="https://github.com/QuantLet/Network_Centrality" target="_blank" rel="noreferrer">View code <span aria-hidden="true">↗</span></a></div></article>
    <article class="resource-card"><img src="{{ '/assets/code-previews/hierarchical-loans-code.png' | relative_url }}" alt="Hierarchical Loan Forecasting code output" loading="lazy"><div><h3>Hierarchical Loan Forecasting</h3><p>Code for hierarchical loan forecasting using a public dataset of Italian loan originations.</p><p class="companion">Companion code to <a href="https://quantinar.com/course/891/hierarchical-loan-forecasting?q=Hierarchical%20Loan%20Forecasting" target="_blank" rel="noreferrer">Hierarchical Loan Forecasting</a>.</p><a class="card-link" href="https://github.com/QuantLet/Hierarchical-Loan-Forecasting" target="_blank" rel="noreferrer">View code <span aria-hidden="true">↗</span></a></div></article>
    <article class="resource-card"><img src="{{ '/assets/code-previews/proper-scoring-rules-code.png' | relative_url }}" alt="Proper Scoring Rules code output" loading="lazy"><div><h3>Proper Scoring Rules</h3><p>Code for reproducing the examples in the talk on proper scoring rules.</p><p class="companion">Companion code to <a href="https://quantinar.com/course/991/proper-scoring-rules" target="_blank" rel="noreferrer">Proper Scoring Rules</a>.</p><a class="card-link" href="https://github.com/QuantLet/Proper-Scoring-Rules" target="_blank" rel="noreferrer">View code <span aria-hidden="true">↗</span></a></div></article>
    <article class="resource-card"><img src="{{ '/assets/code-previews/LLM-for-BTC-code.png' | relative_url }}" alt="LLMs for BTC forecasting code output" loading="lazy"><div><h3>LLMs for BTC forecasting</h3><p>Code for reproducing figures from the published paper.</p><a class="card-link" href="https://github.com/QuantLet/LLMs-for-BTC-TS/tree/main/2.%20Fractional%20differencing" target="_blank" rel="noreferrer">View code <span aria-hidden="true">↗</span></a><a class="secondary-link" href="https://www.sciencedirect.com/science/article/pii/S0950705125014881" target="_blank" rel="noreferrer">View paper <span aria-hidden="true">↗</span></a></div></article>
  </div>
</section>
...
<section class="portfolio-section plain-section" id="data" aria-labelledby="data-title">
  ...
  <div class="resource-grid data-grid">
    <article class="resource-card"><img src="{{ '/assets/talk-previews/placeholder.svg' | relative_url }}" alt="Placeholder for Zenodo dataset preview" loading="lazy"><div><h3>Stablecoin DeFi Hourly Dataset</h3><p>Open research data.</p><a class="card-link" href="https://zenodo.org/records/22037835" target="_blank" rel="noreferrer">View dataset <span aria-hidden="true">↗</span></a></div></article>
    <article class="resource-card"><img src="{{ '/assets/talk-previews/placeholder.svg' | relative_url }}" alt="Placeholder for Zenodo dataset preview" loading="lazy"><div><h3>Sarafu Network Public Dataset</h3><p>Open research data.</p><a class="card-link" href="https://zenodo.org/records/20120190" target="_blank" rel="noreferrer">View dataset <span aria-hidden="true">↗</span></a></div></article>
  </div>
</section>
